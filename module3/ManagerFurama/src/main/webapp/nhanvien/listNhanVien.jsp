...
<div class="container">
    <aside class="left-sidebar">
        <button><a href="/nhanvien?action=create">Them moi</a></button>
        ...
        <table border="1">
            ...
            <c:forEach items="${nhanVienList}" var="nhanVienList">
                <tr>
                    ...
                    <td><a href="/nhanvien?action=update&manhanvien=${nhanVienList.manhanvien}">Update</a>|
                        <a href="/nhanvien?action=delete&manhanvien=${nhanVienList.manhanvien}">Delete</a></td>
                </tr>
            </c:forEach>
        </table>
